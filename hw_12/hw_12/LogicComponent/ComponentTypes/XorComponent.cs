...
public class XorComponent : BaseComponent
{
    ...
    private void DrawGost(DrawingContext context)
    {
        ...
        context.DrawEllipse(Brushes.Blue, null, new Avalonia.Point(Width - 42, centerY - 6), ConnectorRadius, ConnectorRadius);
    }
    ...
    private void DrawAnsi(DrawingContext context)
    {
        ...
        {
            var y = inputSpacing * (i + 1);
            context.DrawEllipse(Brushes.Red, null, new Avalonia.Point(25, y + 3), ConnectorRadius, ConnectorRadius);
        }

        // Отрисовка точки выхода
        context.DrawEllipse(Brushes.Blue, null, new Avalonia.Point(Width - 23, centerY - 9), ConnectorRadius, ConnectorRadius);
    }
}