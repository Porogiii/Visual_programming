...
public class OrNoComponent : BaseComponent
{
    ...
    private void DrawGost(DrawingContext context)
    {
        ...
        for (var i = 0; i < InputCount; i++)
        {
            ...
            context.DrawEllipse(Brushes.Red, null, new Avalonia.Point(35, y + 5), ConnectorRadius, ConnectorRadius);
        }
        // Отрисовка точки выхода
        var outputX = Width - 32;
    ...
    private void DrawAnsi(DrawingContext context)
    {
        ...
        {
            var y = inputSpacing * (i + 1);
            context.DrawEllipse(Brushes.Red, null, new Avalonia.Point(31, y + 3), ConnectorRadius, ConnectorRadius);
        }

        // Отрисовка точки выхода
        var outputX = Width - 25;
        var outputY = centerY - 9;
        var outputRadius = ConnectorRadius;
        var ringRadius = ConnectorRadius + 2;
        var ringStrokeThickness = 1;
