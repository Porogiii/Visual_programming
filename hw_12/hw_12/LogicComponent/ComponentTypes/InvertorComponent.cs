...
public class InvertorComponent : BaseComponent
{
    ...
    private void DrawGost(DrawingContext context)
    {
        ...
        for (var i = 0; i < InputCount; i++)
        {
            ...
            context.DrawEllipse(Brushes.Red, null, new Avalonia.Point(32, y - 5), ConnectorRadius, ConnectorRadius);
        }
        // Отрисовка точки выхода
        var outputX = Width - 41;
    ...
    private void DrawAnsi(DrawingContext context)
    {
        ...
        {
            var y = inputSpacing * (i + 1);
            context.DrawEllipse(Brushes.Red, null, new Avalonia.Point(35, y - 10), ConnectorRadius, ConnectorRadius);
        }

        // Отрисовка точки выхода
        var outputX = Width - 29;
