...
public class XorNoComponent : BaseComponent
{
    ...
    private void DrawGost(DrawingContext context)
    {
        ...
        for (var i = 0; i < InputCount; i++)
        {
            ...
            context.DrawEllipse(Brushes.Red, null, new Avalonia.Point(35, y - 8), ConnectorRadius, ConnectorRadius);
        }

        var outputX = Width - 43;
        var outputY = centerY - 8;
    ...
    private void DrawAnsi(DrawingContext context)
    {
        ...
        {
            var y = inputSpacing * (i + 1);
            context.DrawEllipse(Brushes.Red, null, new Avalonia.Point(30, y + 3), ConnectorRadius, ConnectorRadius);
        }

        var outputX = Width - 26;
        var outputY = centerY - 10;
        var outputRadius = ConnectorRadius;
        var ringRadius = ConnectorRadius + 2;
        var ringStrokeThickness = 1;
