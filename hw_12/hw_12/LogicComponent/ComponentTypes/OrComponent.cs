...
public class OrComponent : BaseComponent
{
    ...
    private void DrawGost(DrawingContext context)
    {
        ...
        context.DrawEllipse(Brushes.Blue, null, new Avalonia.Point(Width - 35, centerY - 6), ConnectorRadius, ConnectorRadius);
    ...
    private void DrawAnsi(DrawingContext context)
    {
        ...
        {
            var y = inputSpacing * (i + 1);
            context.DrawEllipse(Brushes.Red, null, new Avalonia.Point(35, y + 1), ConnectorRadius, ConnectorRadius);
        }

        // Отрисовка точки выхода
        context.DrawEllipse(Brushes.Blue, null, new Avalonia.Point(Width - 23, centerY - 11), ConnectorRadius, ConnectorRadius);
